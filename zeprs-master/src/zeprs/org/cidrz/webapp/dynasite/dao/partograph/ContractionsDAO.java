...
import org.cidrz.project.zeprs.valueobject.partograph.Contractions;
...
/**
 * @author <a href="mailto:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a6c5cdc3cacac3dfe6d4d2cf88c9d4c1">[email protected]</a>">Chris Kelley</a>
 *         Date: Jul 4, 2005
 *         Time: 9:22:16 AM
 */
public class ContractionsDAO implements PersistenceDAO {
    ...
    public BaseRecord getOne(Connection conn, Long patientId, Long pregnancyId) throws SQLException, ServletException, IOException, ObjectNotFoundException {
        ...
        String sql = (String) queries.get("SQL_RETRIEVE_CONTRACTIONS");
        Contractions item = null;
        ArrayList values;
        values = new ArrayList();
        values.add(patientId);
        values.add(pregnancyId);
        item = (Contractions) DatabaseUtils.getBean(conn, Contractions.class, sql, values);
        return item;
    }

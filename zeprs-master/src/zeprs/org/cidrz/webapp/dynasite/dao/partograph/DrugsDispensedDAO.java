...
import org.cidrz.project.zeprs.valueobject.partograph.DrugsDispensed;
...
/**
 * @author <a href="mailto:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="51323a343d3d3428112325387f3e2336">[email protected]</a>">Chris Kelley</a>
 *         Date: Jul 6, 2005
 *         Time: 9:22:16 AM
 */
public class DrugsDispensedDAO implements PersistenceDAO {
    ...
    public BaseRecord getOne(Connection conn, Long patientId, Long pregnancyId) throws SQLException, ServletException, IOException, ObjectNotFoundException {
        ...
        String sql = (String) queries.get("SQL_RETRIEVE_DRUGSDISPENSED");
        DrugsDispensed item = null;
        ArrayList values;
        values = new ArrayList();
        values.add(patientId);
        values.add(pregnancyId);
        item = (DrugsDispensed) DatabaseUtils.getBean(conn, DrugsDispensed.class, sql, values);
        return item;
    }

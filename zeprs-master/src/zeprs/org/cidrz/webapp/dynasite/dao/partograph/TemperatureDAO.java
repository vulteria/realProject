...
import org.cidrz.project.zeprs.valueobject.partograph.Temperature;
...
/**
 * @author <a href="mailto:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2a49414f46464f536a585e430445584d">[email protected]</a>">Chris Kelley</a>
 *         Date: Jul 6, 2005
 *         Time: 9:22:16 AM
 */
public class TemperatureDAO implements PersistenceDAO {
    ...
    public BaseRecord getOne(Connection conn, Long patientId, Long pregnancyId) throws SQLException, ServletException, IOException, ObjectNotFoundException {
        ...
        String sql = (String) queries.get("SQL_RETRIEVE_TEMPERATURE");
        Temperature item = null;
        ArrayList values;
        values = new ArrayList();
        values.add(patientId);
        values.add(pregnancyId);
        item = (Temperature) DatabaseUtils.getZEPRSBean(conn, Temperature.class, sql, values);
        return item;
    }

...
import org.cidrz.project.zeprs.valueobject.partograph.Descent;
...
/**
 * @author <a href="mailto:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6d0e0608010108142d1f190443021f0a">[email protected]</a>">Chris Kelley</a>
 *         Date: Jul 6, 2005
 *         Time: 9:22:16 AM
 */
public class DescentDAO implements PersistenceDAO {
    ...
    public BaseRecord getOne(Connection conn, Long patientId, Long pregnancyId) throws SQLException, ServletException, IOException, ObjectNotFoundException {
        ...
        String sql = (String) queries.get("SQL_RETRIEVE_DESCENT");
        Descent item = null;
        ArrayList values;
        values = new ArrayList();
        values.add(patientId);
        values.add(pregnancyId);
        item = (Descent) DatabaseUtils.getZEPRSBean(conn, Descent.class, sql, values);
        return item;
    }

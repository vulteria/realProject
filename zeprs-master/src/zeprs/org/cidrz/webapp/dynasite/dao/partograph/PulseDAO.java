...
import org.cidrz.project.zeprs.valueobject.partograph.Pulse;
...
/**
 * @author <a href="mailto:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="620109070e0e071b2210160b4c0d1005">[email protected]</a>">Chris Kelley</a>
 *         Date: Jul 6, 2005
 *         Time: 9:22:16 AM
 */
public class PulseDAO implements PersistenceDAO {
    ...
    public BaseRecord getOne(Connection conn, Long patientId, Long pregnancyId) throws SQLException, ServletException, IOException, ObjectNotFoundException {
        ...
        String sql = (String) queries.get("SQL_RETRIEVE_PULSE");
        Pulse item = null;
        ArrayList values;
        values = new ArrayList();
        values.add(patientId);
        values.add(pregnancyId);
        item = (Pulse) DatabaseUtils.getZEPRSBean(conn, Pulse.class, sql, values);
        return item;
    }

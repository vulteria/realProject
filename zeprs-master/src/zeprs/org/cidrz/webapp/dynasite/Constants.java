 ...
 *
 * @author <a href="mailto:<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bfdcd4dad3d3dac6ffcdcbd691d0cdd8">[email protected]</a>">Chris Kelley</a>
 *         Date: Jun 14, 2005
 *         Time: 11:17:13 AM
 */
public class Constants {
    ...
    public static final String DYNASITE_SOURCE_PATH = pathToCatalinaHome + pathSep + "webapps" + pathSep + "zeprs" + pathSep + "WEB-INF" + pathSep + "src" + pathSep;
    public static final String DEV_SOURCE_PATH = LOCAL_DEV_PATH + "src" + pathSep + "zeprs" + pathSep;
    public static final String DYNASITE_RESOURCES_PATH = pathToCatalinaHome + "/webapps/zeprs/WEB-INF/classes/resources/";
    public static final String DEV_RESOURCES_PATH = LOCAL_DEV_PATH + "src" + pathSep + "zeprs" + pathSep + "resources" + pathSep;
    public static final String DEV_XML_PATH = DEV_SOURCE_PATH + "resources" + pathSep + "xml" + pathSep + "forms" + pathSep;
    ...
    public static final String WEBINF_PATH = Constants.pathToCatalinaHome + pathSep + "webapps" + pathSep + "zeprs" + pathSep + "WEB-INF" + pathSep;
    ...
    public static final String DYNASITE_WEBINF_PATH = Constants.pathToCatalinaHome  + pathSep + "webapps" + pathSep + "zeprs" + pathSep + "WEB-INF" + pathSep;
    public static final String DEV_WEBINF_PATH = LOCAL_DEV_PATH + "web"  + pathSep + "zeprs"  + pathSep + "WEB-INF"  + pathSep;
    ...
    public static final String ARCHIVE_PATH_LOGS = pathToCatalinaHome + pathSep + "webapps" + pathSep + "archive" + pathSep + "logs";
    public static final String ARCHIVE_PATH_LOGS_APPUPDATES = pathToCatalinaHome + pathSep + "webapps" + pathSep + "archive" + pathSep + "appupdates";
    ...
    public static final String DEV_DYNASITE_FORMS_SOURCE = Constants.DEV_SOURCE_PATH + "org" + pathSep + "cidrz" + pathSep + "project" + pathSep + "zeprs" + pathSep + "valueobject" + pathSep + "gen" + pathSep;
    public static final String DEPLOY_DYNASITE_FORMS_SOURCE = Constants.DYNASITE_SOURCE_PATH + "org" + pathSep + "cidrz" + pathSep + "project" + pathSep + "zeprs" + pathSep + "valueobject" + pathSep + "gen" + pathSep;
    public static final String DEV_DYNASITE_REPORTS_SOURCE = Constants.DEV_SOURCE_PATH + "org" + pathSep + "cidrz" + pathSep + "project" + pathSep + "zeprs" + pathSep + "valueobject" + pathSep + "report" + pathSep + "gen" + pathSep;
    public static final String DEPLOY_DYNASITE_REPORTS_SOURCE = Constants.DYNASITE_SOURCE_PATH + "org" + pathSep + "cidrz" + pathSep + "project" + pathSep + "zeprs" + pathSep + "valueobject" + pathSep + "report" + pathSep + "gen" + pathSep;
